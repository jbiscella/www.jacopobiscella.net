...
*Part 4 of 7 in the [Heikin Ashi series](#series-navigation). The project's full `CLAUDE.md` spec is [on GitHub](https://github.com/jbiscella/H-tchen-Mail/blob/main/CLAUDE.md).*
